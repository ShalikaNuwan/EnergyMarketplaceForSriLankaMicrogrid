...
class GeneralPriceAlgorithm:
    ...
    def calculatePrice(self,solar_unit_cost,battery_unit_cost,demandFactor):
        ...
        if (self.isDemSupMatch and not self.solar_surplus and not self.batery_charging and not self.battery_discharging):
...
new = GeneralPriceAlgorithm(demand=80,supply=150,isDemSupMatch=True,battery_allocation=30,batteryCharging=True,battery_dischargig=False,solar_surplus=True)
